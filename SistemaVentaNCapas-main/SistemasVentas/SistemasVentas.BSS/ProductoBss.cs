...
namespace SistemasVentas.BSS
{
    public class ProductoBss
    {
        ...
        public DataTable ProductosBss()
        {
            return dal.ProductosDal();
        }
        public DataTable ProductosCincoBss()
        {
            return dal.ProductosCincoDal();
        }
        public DataTable ProductosSeisBss()
        {
            return dal.ProductosSeisDal();
        }
    }
}
