...
namespace SistemasVentas.BSS
{
    public class ClienteBss
    {
        ...
        public DataTable ClientesDatosBss()
        {
            return dal.ClientesDatosDal();
        }
        public DataTable ClientesBss()
        {
            return dal.ClientesDal();
        }
        public DataTable ClientesSieteBss()
        {
            return dal.ClientesSieteDal();
        }
