...
namespace SistemasVentas.DAL
{
    public class MarcaDal
    {
        ...
        public DataTable MarcasDal()
        {
            string consulta = "SELECT TOP 1 PRODUCTO.IDMARCA, MARCA.NOMBRE, SUM(DETALLEVENTA.CANTIDAD) AS CantidadTotal\nFROM MARCA\nINNER JOIN PRODUCTO ON MARCA.IDMARCA = PRODUCTO.IDMARCA\nINNER JOIN DETALLEVENTA ON PRODUCTO.IDPRODUCTO = DETALLEVENTA.IDPRODUCTO\nGROUP BY PRODUCTO.IDMARCA, MARCA.NOMBRE\nORDER BY CantidadTotal DESC;";
